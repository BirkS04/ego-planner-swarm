...
PerceptionUtils::PerceptionUtils(rclcpp::Node::SharedPtr nh) {
  
  // ROS2 Parameterdeklaration und Auslesen
  nh->declare_parameter("perception_utils.top_angle", 0.56125);
  nh->declare_parameter("perception_utils.left_angle", 0.69222);
  nh->declare_parameter("perception_utils.right_angle", 0.68901);
  nh->declare_parameter("perception_utils.max_dist", 4.5);
  nh->declare_parameter("perception_utils.vis_dist", 1.0);
